...
const PROMPTS = {
  ...
  hero_dark: `Cinematic editorial photograph of an olive grove at twilight blue hour in South Africa's Breede River Valley. Silver-grey olive trees in deep silhouette against a dramatic dusk sky, the very last orange-pink light fading behind distant Cape Fold mountain ranges. The bottom two thirds of the frame is in deep shadow — only the upper sky and mountain ridge catch the dying light. Atmospheric, contemplative, moody. Deep shadows in the foreground and middle distance. Dark colour palette: midnight green, charcoal, fading amber, deep cobalt. No people. No text. No borders. Shot on medium format, 35mm lens, f/4, long exposure feel. Premium magazine cinematic quality.`,
}
